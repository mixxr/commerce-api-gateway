...
type IDatastore interface {
	...
	// update
	UpdateTable(t *models.Table) error
	AddColnames(t *models.Table) error // add additional entry in <table>_colnames
	AddValues(t *models.Table) error   // add additional entries in <table>_values
	// read
